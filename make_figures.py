...
DUTTA_4BIT_MMLU_MIN = 5.65
DUTTA_4BIT_MMLU_MAX = 10.90
...
def main():
    ...
    if base and q:
        ...
        ax.set_xlabel("Full-precision confidence on the changed correct answer")
        ax.set_ylabel("Count")
        ax.set_title("Correct answers changed to incorrect", fontsize=11)
    ...
    print("Fig1: Replication of the flips finding on current small models. Bars "
          "show the 4-bit MMLU Flips rate per model; the shaded band marks the "
          "5.7 to 10.9 percent range Dutta et al. report for their 2023 chat models "
          "on the same metric (their Table 5). The smaller models we test sit at the "
          "upper end of that range or above it, consistent with the original finding "
          "that smaller models show more flips.\n")
    print("Fig2: Directional imbalance of flips under 4-bit quantization, averaged "
          ...
          "and incorrect-to-correct flips per benchmark. Every model leans toward "
          "correct-to-incorrect; the balance sits between the original near-even "
          "result and the three-to-one a four-option task would produce by chance.\n")
    ...
    print("Fig4: Full-precision confidence on the correct answers that 4-bit "
          "quantization changed to incorrect (Qwen2.5-1.5B, MMLU). Most were weakly "
          "held, a minority above 0.90 the full model was confident about.\n")
